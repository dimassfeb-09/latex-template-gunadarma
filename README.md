...
- **VS Code** dengan ekstensi **LaTeX Workshop** (Sangat Direkomendasikan).
- **TeXstudio**: Ringan dan fitur lengkap.
- **Overleaf**: Jika ingin mengerjakan secara online (tinggal upload folder ini).
...
pdflatex main.tex
```
*Catatan: Menjalankan `pdflatex` beberapa kali diperlukan agar daftar isi dan sitasi terupdate dengan benar.*
...
---
*Dibuat untuk mempermudah pejuang skripsi Gunadarma! Selamat mengerjakan.*
